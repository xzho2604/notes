...
" In /eovim, you can set up fzf window using a Vim command
...
" Mapping ctl n for neard tree
map <silent> <C-n> :NERDTreeToggle <CR>
" Mapping ctl f for set focus on Neartree
map <silent> <C-f> :NERDTreeFocus <CR>


" set the run time path of ctrlp
set runtimepath^=~/.vim/bundle/ctrlp.vim
" vim will look for tags from the current dir if not will go up to parent dir
" until find it
set tags=./tags,tags;

" set the command for ctrlp
let g:ctrlp_map = '<c-p>'
let g:ctrlp_cmd = 'CtrlP'

" map \. to the CtrlPTag command
